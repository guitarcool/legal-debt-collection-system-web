    ...
    <div class="app-container">
            ...
            <template #default>
                <el-form-item label="类型：">
                    <el-select size="small" filterable v-model="queryParams.type" placeholder="请选择">
                        <el-option v-for="item in messageOptions" :key="item.dictValue" :label="item.dictLabel"
                            :value="item.dictValue">
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
                    <el-input v-model="queryParams.content" placeholder="请输入搜索关键字，包括单号、类型、正文内容、审批意见" clearable
                        size="small" style="width: 480px" @keyup.enter.native="handleQuery" />
                </el-form-item>
            </template>
            <template #filter>
        ...
        <div class="box-contnet-wrap">
            <el-table class="wrap-table" v-loading="loading" :data="caseList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="类型" :formatter="statusFormat" prop="type" :show-overflow-tooltip="true"
                    fixed="left" width="80" />
