<template>
    <div class="case-info">
            ...
            <div class="box-title two-distribution">
                ...
                <div>
                    ...
                    <el-dropdown slot="append" style="margin-right:10px" v-if="firstInfo.caseStatus != 13">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-hasPermi="['case:pretrial:repayment']"
        ...
        <div class="box">
            ...
            " type="success" @click="applyEdit" v-hasPermi="['case:pretrial:letterRepair']">申请案件信修</el-button>
                            </span>
                        </p>
                        <div>
        ...
        methods: {
            ...
            multipleSuccess(item) {
                ...
                this.multipleSuccessfully.requestApi =
                    "/case/pretrial/multiMediateSuccess";
            ...
            handleReimbursement(type) {
                ...
                this.reimbursementData.title = type == 0 ? "裁前部分还款" : "裁前结清";
