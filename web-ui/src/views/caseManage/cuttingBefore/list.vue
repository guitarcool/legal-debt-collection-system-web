        ...
        <search-bar v-show="showSearch" :model="queryParams" :has-filter="hasFilter" :flag="true" @submit="getList(1)"
            ...
            <template #default>
                ...
                <el-form-item label="联系结果：">
                    <el-select clearable filterable size="small" v-model="queryParams.medLabel" placeholder="请选择">
                ...
                <el-form-item label="账龄（M）：">
                    <el-input size="small" style="width:100px" clearable v-model="queryParams.overdueStartAge" />~
                    <el-input size="small" style="width:100px" clearable v-model="queryParams.overdueEndAge" />
                </el-form-item>
