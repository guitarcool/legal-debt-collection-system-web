    ...
    <div class="app-container">
        ...
        <div class="box-contnet-wrap" style="margin-top:0">
            ...
            <el-table v-loading="loading" max-height="550" :data="caseList" @sort-change="handleSortChange"
                ...
                <el-table-column label="财务审核状态" width="130" :formatter="reviewStatusFormat" prop="reviewStatus">
                </el-table-column>
                ...
                <el-table-column label="备注" width="150" prop="amount" />
                <el-table-column label="借款平台" width="150" prop="amount" />
                ...
                <el-table-column label="调解员" prop="reviewName" />
