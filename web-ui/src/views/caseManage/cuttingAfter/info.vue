<template>
    <div class="case-info">
        ...
        <div class="box">
                ...
                <div>
                    ...
                    <el-dropdown style="margin-right:10px" v-if="firstInfo.caseStatus != 13" @command="changeButton">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-for="(item, index) in componentsName" :command="item.eName"
                                :key="index">
                                {{ item.cName }}
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    ...
                    <el-dropdown slot="append" v-if="firstInfo.caseStatus != 13">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-hasPermi="['case:adjudged:repayment']"
                                @click.native="handleReimbursement(0)">部分还款</el-dropdown-item>
                            <el-dropdown-item v-hasPermi="['case:adjudged:repayment']"
            ...
            <div class="box-content">
                ...
                <div class="small-three">
                    ...
                    <p class="small-unit-conent">{{ repayFormat(firstInfo.repayStatus) }}</p>
                </div>
                <div class="small-three">
                    <p class="small-unit-header">联系状态：</p>
                    <p class="small-unit-conent">{{ contactStatusFormat(firstInfo.contactStatus) }}</p>
                </div>
                <div class="small-three">
                    <p class="small-unit-header">财保状态：</p>
                    <p class="small-unit-conent">{{ preStatusFormat(firstInfo.preStatus) }}</p>
                </div>
                <div class="small-three">
                    <p class="small-unit-header">最近一次网调标签：</p>
                    <p class="small-unit-conent">{{ adjustFormat(firstInfo.networkAdjustLabel) }}</p>
                </div>
                <div class="small-three">
                    <p class="small-unit-header">最近一次调解标签：</p>
                    <p class="small-unit-conent">{{ contactResultFormat(firstInfo.medLable) }}</p>
                </div>
                <div class="small-three">
                    <p class="small-unit-header">承诺还款日：</p>
                    <p class="small-unit-conent">{{ parseTime(firstInfo.promiseRepayDate, "{y}-{m}-{d}") }}</p>
                </div>
                <div class="small-three">
            ...
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                <el-tab-pane label="标的详情" name="subject">
                    <div class="box-content" v-if="subjectInfo">
                        <div class="small-three">
                            <p class="small-unit-header">放贷主体：</p>
                            <p class="small-unit-conent">{{ subjectInfo.loanSubject }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">产品名称：</p>
                            <p class="small-unit-conent">{{ subjectInfo.productName }}</p>
                        </div>
                        <div class="small-three">
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">{{ subjectInfo.assetTransferor }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">资产受让方：</p>
                            <p class="small-unit-conent">{{ subjectInfo.assetAssignee }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header"></p>
                            <p class="small-unit-conent"></p>
                        ...
                        <div class="small-three" style="margin-bottom:20px">
                            ...
                            <p class="small-unit-conent">{{ subjectInfo.orderNo }}</p>
                        </div>
                        <div class="small-three" style="margin-bottom:20px">
                            <p class="small-unit-header">合同签订日期：</p>
                            <p class="small-unit-conent">{{ subjectInfo.contractSignDate }}</p>
                        </div>
                        <div class="small-three" style="margin-bottom:20px">
                            <p class="small-unit-header">合同地址：</p>
                            <p class="small-unit-conent">{{ subjectInfo.contractAddr }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">借款本金：</p>
                            <p class="small-unit-conent">{{ subjectInfo.capital }}</p>
                        </div>
                        <div class="small-three">
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">{{ subjectInfo.loanDate }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">收款银行账号：</p>
                            <p class="small-unit-conent">{{ subjectInfo.dueBankAccount }}</p>
                        </div>
                        <div class="small-three">
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">
                                {{ parseTime(subjectInfo.firstRepayLocalDateTime, "{y}-{m}-{d}") }}
                            </p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">起始已还本金：</p>
                            <p class="small-unit-conent">{{ subjectInfo.repaidCapital }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">已还期数：</p>
                            <p class="small-unit-conent">{{ subjectInfo.repaidTerms }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">末次还款日期：</p>
                            <p class="small-unit-conent">{{ subjectInfo.lastRepayLocalDateTime }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">逾期时间：</p>
                            <p class="small-unit-conent">{{ subjectInfo.overdueStartTime }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">逾期天数：</p>
                            <p class="small-unit-conent">{{ subjectInfo.overdueDay }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">剩余待还本金：</p>
                            <p class="small-unit-conent">{{ subjectInfo.overdueCapital }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">剩余待还利息：</p>
                            <p class="small-unit-conent">{{ subjectInfo.overdueInterest }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">剩余待还其他费用：</p>
                            <p class="small-unit-conent">{{ subjectInfo.overdueOtherFee }}
                            </p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">诉讼费：</p>
                            <p class="small-unit-conent">{{ subjectInfo.legalCosts }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header"></p>
                            <p class="small-unit-conent"></p>
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">{{ subjectInfo.repayAmount }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">调解待还总额：</p>
                            <p class="small-unit-conent">{{ subjectInfo.outstandingAmount }}</p>
                        </div>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="联系号码" name="contact">
                    ...
                    <div class="box" style="margin-bottom:0px">
                        <p class="box-title two-distribution">
                            ...
                            <span>
                                <el-button size="mini" type="primary" @click="addPhone(firstInfo.name)"
                                    v-hasPermi="['case:relatedInfo:adjudgedAdd']">新增</el-button>
                                <el-button v-if="firstInfo.caseStatus != 13" size="mini" :disabled="
              firstInfo.letterRepairStatus == 1 || firstInfo.letterRepairStatus == 2
            " type="success" @click="applyEdit" v-hasPermi="['case:adjudged:letterRepair']">申请案件信修</el-button>
                            </span>
                        </p>
                        <div>
                            <el-table ref="singleTable" :data="contactInfosList" :cell-style="singlecellStyle"
                                style="width: 100%; margin-top: 20px">
                                <el-table-column prop="relatedRelation" label="关系">
                                    <template>
                                        <span>本人</span>
                                    </template>
                                </el-table-column>
                                <el-table-column label="姓名" prop="respondentName">
                                </el-table-column>
                                <el-table-column prop="phone" label="电话号码">
                                    <template slot="header">
                                        <el-tooltip effect="dark" content="失联、空号、停机”号码为标记为红色" placement="top">
                                            <span>电话号码<i class="el-icon-info"></i></span>
                                        </el-tooltip>
                                    </template>
                                </el-table-column>
                                ...
                                <el-table-column label="号码筛选结果" prop="screenResult">
                                    <template slot-scope="scope">
                                        <span
                                            v-if="scope.row.screenType == 1">{{ networkSortresultFormat(scope.row.screenResult) }}</span>
                                        <span v-else>{{ realtimeSortresultFormat(scope.row.screenResult) }}</span>
                                    </template>
                                </el-table-column>
                                <el-table-column label="已拨次数" prop="frequency"> </el-table-column>
                                <el-table-column label="操作" width="400" fixed="right" align="center">
                                    <template slot-scope="scope">
                                        <el-button size="mini" type="warning" v-if="firstInfo.caseStatus != 13&&token"
                                            @click="callMe(scope.row)">一键外呼
                                        </el-button>
                                        <el-button size="mini" type="primary" v-if="firstInfo.caseStatus != 13"
                                            v-hasPermi="['shortMsg:send']" @click="handleExport(scope.row)">短信发送
                                        </el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
                    ...
                    <div class="box" style="margin-bottom:0px">
                        ...
                        <div>
                            <el-table ref="table" :data="relationalContactList" :cell-style="cellStyle"
                                style="width: 100%; margin-top: 20px">
                                <el-table-column prop="relatedRelation" label="关系">
                                </el-table-column>
                                <el-table-column prop="relatedName" label="姓名"> </el-table-column>
                                <el-table-column prop="relatedContact" label="电话号码">
                                    <template slot="header">
                                        <el-tooltip effect="dark" content="失联、空号、停机”号码为标记为红色" placement="top">
                                            <span>电话号码<i class="el-icon-info"></i></span>
                                        </el-tooltip>
                ...
                <el-tab-pane label="债务人基本信息" name="borrower">
                    <div class="box-content" v-if="borrowerInfo">
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">{{ borrowerInfo.respondentName }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">身份证号：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentIdNo }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">性别：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentSex }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">出生日期：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentBirthday }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">户籍地址：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentAddress }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">工作单位名称：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.workUnitName }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">单位电话：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.workUnitPhone }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">邮箱：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentEmail }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">QQ：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentQq }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">微信：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentChat }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">学历：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentEducation }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">职业：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.respondentOccupation }}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">婚姻状况：</p>
                            <p class="small-unit-conent">{{ borrowerInfo.maritalStatus }}</p>
                        </div>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="收款账户" name="repayAccount">
                    <!--收款账户-->
                    <div class="box" style="margin-bottom:0px">
                        <el-button type="primary" @click="seeErweima(repayAccountList[0])" size="mini">商户收款码
                        </el-button>
                        <el-table :data="repayAccountList" style="width: 100%; margin-top: 20px">
                            <el-table-column prop="accountType" label="收款账户类型" width="200"
                                :show-overflow-tooltip="true">
                            </el-table-column>
                            <el-table-column prop="accountNumber" label="收款账户" width="200"
                                :show-overflow-tooltip="true">
                            </el-table-column>
                            <el-table-column prop="accountName" label="收款账户名" :show-overflow-tooltip="true">
                            </el-table-column>
                            <el-table-column prop="openbankName" label="开户行名称" :show-overflow-tooltip="true">
                            </el-table-column>
                ...
                <el-tab-pane label="备注" name="remark">
                    <div class="box-content" v-if="remarkInfo">
                        <div class="small-unit">
                            ...
                            <p class="small-unit-conent">{{remarkInfo.remark}}</p>
                        </div>
                        <div class="small-unit">
                            <p class="small-unit-header">备注2：</p>
                            <p class="small-unit-conent">{{remarkInfo.remark2}}</p>
                        </div>
                        <div class="small-unit">
                            <p class="small-unit-header">备注3：</p>
                            <p class="small-unit-conent">{{remarkInfo.remark3}}</p>
                        </div>
                        <div class="small-unit">
                            <p class="small-unit-header">备注4：</p>
                            <p class="small-unit-conent">{{remarkInfo.remark4}}</p>
                        </div>
                        <div class="small-unit">
                            <p class="small-unit-header">备注5：</p>
                            <p class="small-unit-conent">{{remarkInfo.remark5}}</p>
                        </div>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="诉前财保" name="preProperty">
                    <div class="box-content" v-if="prePropertyInfo">
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">{{prePropertyInfo.frozenStartTime}}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">首次冻结金额：</p>
                            <p class="small-unit-conent">{{prePropertyInfo.frozenAmount}}</p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">车辆情况：</p>
                            <p class="small-unit-conent">{{prePropertyInfo.vehicle}}</p>
                        </div>
                        <div class="small-three">
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">{{prePropertyInfo.options}}</p>
                        </div>
                    </div>
                </el-tab-pane>
                    ...
                    <el-form style="margin-top: 20px" :model="ruleForm" :rules="rules" ref="ruleForm"
                        ...
                        <el-form-item class="big-margin" label="标签" prop="medLabel">
                            <el-radio-group v-model="ruleForm.medLabel">
                                <el-radio v-for="item in contactResultOptions" :key="item.dictValue"
                        ...
                        <el-form-item label="内容">
                            <el-input style="width:400px;" type="textarea" v-model="ruleForm.medContent"></el-input>
                        </el-form-item>
                        <el-collapse accordion>
                            <el-collapse-item>
                                ...
                                <el-form-item label="调解还款总额" prop="repayAmount">
                                    <el-input style="width:400px;" placeholder="请填写协议后的还款总额" type="text"
                                        v-model="ruleForm.repayAmount"></el-input>
                                </el-form-item>
                                <el-form-item label="调解时间" prop="repayDate">
                                    <el-input style="width:400px;" placeholder="请填写调解时间" type="text"
                                        v-model="ruleForm.repayDate"></el-input>
                                </el-form-item>
                                <el-form-item label="调解详情内容" prop="term">
                                    <el-input style="width:400px;" placeholder="请填写双方达成协议的内容，如偿还方式，本内容可应用于一键生成调解协议"
                                        type="textarea" :rows="4" v-model="ruleForm.term"></el-input>
                                </el-form-item>
                            </el-collapse-item>
                        </el-collapse>
                        <el-form-item>
                    ...
                    <el-form ref="adjustmentForm" style="margin-top: 20px" :model="adjustmentForm"
                        ...
                        <el-form-item label="网调标签：" prop="label">
                            <el-radio-group v-model="adjustmentForm.label">
                                <el-radio v-for="item in adjustType" :key="item.dictValue" :label="item.dictValue">
        ...
        <div class="box">
            <el-tooltip style="float: right;position: relative;z-index: 11;" class="item" effect="dark" content="刷新"
                placement="top">
                <el-button circle icon="el-icon-refresh" @click="getCaseRecordInfo(caseType)" />
            </el-tooltip>
            <el-tabs v-model="activeNameThree" type="card" @tab-click="handleClickThree">
                ...
                <el-tab-pane label="网调记录" name="netRecord">
                    <!--网调记录列表-->
                    <div class="box" style="margin-bottom:0px;padding-top:0px">
                        <el-table ref="table" :data="netRecordList" style="width: 100%; margin-top: 20px">
                ...
                <el-tab-pane label="通话记录" name="callRecord">
                    <!-- 通话记录列表 -->
                    <div class="box" style="margin-bottom:0px;padding-top:0px">
                        <el-table border class="wrap-table" :data="callRecordList"
                            style="width: 100%; margin-top: 20px">
                            <el-table-column label="呼叫时间" :show-overflow-tooltip="true" width="180" prop="callTime">
                                <template slot-scope="scope">
                                    <span>
                                        {{ parseTime(scope.row.callTime, "{y}-{m}-{d} {h}:{i}:{s}") }}</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="主叫号码" :show-overflow-tooltip="true" width="150" prop="caller">
                            </el-table-column>
                            <el-table-column label="被叫号码" :show-overflow-tooltip="true" width="150" prop="callee">
                            </el-table-column>
                            <el-table-column prop="type" label="呼出类型" :show-overflow-tooltip="true" width="100">
                            ...
                            <el-table-column label="通话时长" width="100" prop="duration">
                                <template slot-scope="scope" v-if="scope.row.duration != null">
                                    <span>{{scope.row.duration}}秒</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="outcome" label="呼叫结果" :show-overflow-tooltip="true" width="100">
                                <template slot-scope="scope" v-if="scope.row.outcome != null">
                                    <span>{{scope.row.outcome=='SUCCESS'?'成功':scope.row.outcome=='USER_BUSY'?'正忙':scope.row.outcome=='POWER_OFF'?'用户关机':scope.row.outcome=='SUSPENDED'?'用户停机':scope.row.outcome=='NOT_EXIST'?'用户空号':'失败'}}</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="seatWord" label="坐席敏感词" :show-overflow-tooltip="true" width="150">
                            </el-table-column>
                            <el-table-column prop="isSeatWord" label="坐席是否有敏感词" :show-overflow-tooltip="true"
                                width="210">
                                <template slot-scope="scope" v-if="scope.row.isSeatWord != null">
                                    <span>{{scope.row.isSeatWord==0?'无':'有'}}</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="clientWord" label="客户敏感词" :show-overflow-tooltip="true" width="150">
                            </el-table-column>
                            <el-table-column prop="isClientWord" label="客户是否有敏感词" :show-overflow-tooltip="true"
                                width="210">
                                <template slot-scope="scope" v-if="scope.row.isClientWord != null">
                                    <span>{{scope.row.isClientWord==0?'无':'有'}}</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="createBy" label="操作员" :show-overflow-tooltip="true" width="100">
                            </el-table-column>
                            <el-table-column label="操作" width="180" fixed="right" align="center">
                                <template slot-scope="scope">
                                    <el-button size="mini" type="success" v-if="scope.row.path"
                                        @click="recordingPlay(scope.row)">录音播放
                                    </el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                ...
                <el-tab-pane label="短信发送记录" name="msgRecord">
                    <!-- 短信列表 -->
                    <div class="box" style="margin-bottom:0px;padding-top:0px">
                        <el-table border class="wrap-table" :data="msgRecordList" style="width: 100%; margin-top: 20px">
                            <el-table-column label="姓名" width="100" prop="name"></el-table-column>
                            <el-table-column label="手机号" :show-overflow-tooltip="true" width="150" prop="phone">
                            </el-table-column>
                            <el-table-column prop="content" label="发送内容" :show-overflow-tooltip="true" width="320">
                            </el-table-column>
                            <el-table-column prop="sendTime" label="发送时间" :show-overflow-tooltip="true" width="200">
                                <!-- <template slot-scope="scope">
                                <span>{{ parseTime(scope.row.createTime, "{y}-{m}-{d}") }}</span>
                                </template> -->
                            </el-table-column>
                            <!-- <el-table-column prop="city" label="省市" :show-overflow-tooltip="true" width="150"></el-table-column> -->
                            <el-table-column prop="status" label="发送状态" :show-overflow-tooltip="true" width="210">
                                <template slot-scope="scope" v-if="scope.row.status != null">
                                    <span>{{scope.row.status==0?'发送成功':'发送未成功'}}</span>
                                </template>
                            </el-table-column>
              ...
              <span>{{ parseTime(scope.row.createTime, "{y}-{m}-{d}") }}</span>
                            ...
                            <el-table-column prop="replyContent" label="客户回复内容" :show-overflow-tooltip="true"
                                width="320">
                            </el-table-column>
                            <el-table-column prop="createBy" label="操作员" :show-overflow-tooltip="true" width="100">
                            </el-table-column>
                ...
                <el-tab-pane label="状态变更记录" name="statusRecord">
                    <!--状态变更记录-->
                    <div class="box" style="margin-bottom:0px;padding-top:0px">
                        <el-table class="wrap-table" :data="statusRecordList" style="width: 100%; margin-top: 20px">
                            <el-table-column label="变更前状态" :show-overflow-tooltip="true" width="150">
                                <template slot-scope="scope">
                                    <span>{{ statusFormat(scope.row.beforeStatus) }}</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="当前状态" :show-overflow-tooltip="true" width="150">
                                <template slot-scope="scope">
                            ...
                            <el-table-column prop="annexName" label="附件" :show-overflow-tooltip="true" width="200">
                                <template slot-scope="scope">
                                    <span class="distinguish-style"
                                        @click="downFile(scope.row)">{{scope.row.annexName}}</span>
                                </template>
                            </el-table-column>
                            <el-table-column prop="createName" label="发起人" :show-overflow-tooltip="true" width="150">
                            </el-table-column>
                            <el-table-column prop="createTime" label="发起时间" :show-overflow-tooltip="true" width="210">
                                <template slot-scope="scope">
                                    <span>{{ parseTime(scope.row.createTime, "{y}-{m}-{d}") }}</span>
                                </template>
                            </el-table-column>
        ...
        <normalDialog :confirmTip="normal.confirmTip" :title="normal.title" :id="id" @refresh="getAdjudgedInfo"
            :requestApi="normal.requestApi" :show.sync="normal.dialogVisible">
        </normalDialog>
        <pendingFilling :confirmTip="pendingFilling.confirmTip" :title="pendingFilling.title"
            :statusId="pendingFilling.statusId" :id="id" @refresh="getAdjudgedInfo"
            :requestApi="pendingFilling.requestApi" :show.sync="pendingFilling.dialogVisible">
        </pendingFilling>
        <hasRuled :confirmTip="hasRuled.confirmTip" :title="hasRuled.title" :statusId="hasRuled.statusId" :id="id"
            @refresh="getAdjudgedInfo" :requestApi="hasRuled.requestApi" :show.sync="hasRuled.dialogVisible">
        </hasRuled>
        <multipleSuccess :confirmTip="multipleSuccessfully.confirmTip" :title="multipleSuccessfully.title" :id="id"
            @refresh="getAdjudgedInfo" :requestApi="multipleSuccessfully.requestApi"
            :show.sync="multipleSuccessfully.dialogVisible">
        </multipleSuccess>
        <executedFiling :confirmTip="executedFiling.confirmTip" :title="executedFiling.title"
            :statusId="executedFiling.statusId" :id="id" @refresh="getAdjudgedInfo"
            :requestApi="executedFiling.requestApi" :show.sync="executedFiling.dialogVisible">
        </executedFiling>
        <enforced :confirmTip="enforced.confirmTip" :title="enforced.title" :statusId="enforced.statusId" :id="id"
            @refresh="getAdjudgedInfo" :requestApi="enforced.requestApi" :show.sync="enforced.dialogVisible">
        </enforced>
        <putOnRecord :confirmTip="putOnRecord.confirmTip" :title="putOnRecord.title" :id="id"
        ...
        <exportDialog @refresh="getCaseRecordInfo('msgRecord')" :id="exportDialogData.id"
            :caseId="exportDialogData.caseId" :name="exportDialogData.name" :phone="exportDialogData.phone"
            :title="exportDialogData.title" :show.sync="exportDialogData.dialogVisible" :red="exportDialogData.red">
        </exportDialog>
    ...
    export default {
        ...
        methods: {
            ...
            pendingFiling(item) {
                ...
                this.pendingFilling.requestApi = "/case/postAdjudged/pendingExecute2";
            ...
            contactStatusFormat(contactStatus) {
                return this.selectDictLabel(this.contactStatusOptions, contactStatus);
            },
            //网调标签
            ...
            addStatus(val) {
                if (val.beforeStatus == 7 && val.status == 8) {
                    ...
                    this.putOnRecord.requestApi = "/case/postAdjudged/updateFiledCase";
                    ...
                    this.executedFiling.requestApi = "/case/postAdjudged/updateExecuted";
                    ...
                    this.pendingFilling.requestApi = "/case/postAdjudged/updatePendingExecute2";
