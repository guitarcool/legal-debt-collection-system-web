<template>
    <div class="case-info">
        ...
        <exportSms @refresh="getCaseRecordInfo('msgRecord')" :id="exportSmsData.id"
            :caseId="exportSmsData.caseId" :name="exportSmsData.name" :phone="exportSmsData.phone"
            :title="exportSmsData.title" :show.sync="exportSmsData.dialogVisible" :red="exportSmsData.red">
        </exportSms>
