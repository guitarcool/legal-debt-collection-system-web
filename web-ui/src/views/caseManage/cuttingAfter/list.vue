        ...
        <search-bar v-show="showSearch" :model="queryParams" :has-filter="hasFilter" :flag="true" @submit="getList(1)"
            ...
            <template #default>
                ...
                <el-form-item label="调解员：">
                    <el-select size="small" clearable v-model="queryParams.principal" placeholder="请选择">
                ...
                <el-form-item label="联系结果：">
                    <el-select size="small" clearable v-model="queryParams.medLabel" placeholder="请选择">
                ...
                <el-form-item label="信修状态：">
                    <el-select size="small" clearable v-model="queryParams.letterRepairStatus" placeholder="请选择">
                ...
                <el-form-item label="号码筛选状态：">
                    <el-select size="small" clearable v-model="queryParams.screenStatus" placeholder="请选择">
                ...
                <el-form-item label="号码筛选类型：">
                    <el-select size="small" clearable v-model="queryParams.screenType" placeholder="请选择">
                ...
                <el-form-item label="网调标签：">
                    <el-select size="small" clearable v-model="queryParams.networkAdjustLabel" placeholder="请选择">
                ...
                <el-form-item label="短信送达状态：" v-if="queryParams.providerType">
                    <el-select size="small" clearable v-model="queryParams.lastDeliverStatus" placeholder="请选择">
                ...
                <el-form-item label="客户回复内容：">
                    <el-select size="small" clearable v-model="queryParams.replyContent" placeholder="请选择">
