<template>
    <div>
        <Dialog :title="title" :show.sync="dialogVisible" :height="500" width="60%" @openDialog="openDialog">
            <template v-slot:default>
                ...
                <el-form ref="form" class="custom-display" :model="form" :rules="rules" label-width="120px">
                    <el-form-item label="字段名称：" prop="fieldName">
                        <el-input :disabled="title == '编辑组合字段'" v-model="form.fieldName" placeholder="请输入字段名称">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="字段英文名：" prop="englishName">
                        <el-input :disabled="title == '编辑组合字段'" v-model="form.englishName" placeholder="请输入字段英文名">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="格式类型：" prop="formatType">
                        <el-select v-model="form.formatType" placeholder="请选择">
                            <el-option v-for="item in combinationType" :key="item.dictValue" :label="item.dictLabel"
                    ...
                    <el-form-item label="字段内容：" prop="fieldContent">
                        <span
                            style="color: #72b9e0; font-size: 12px">请在框内编辑循环语句内容，用${字段英文名}表示需要映射的字段，可点击“查看字段表”查看字段，支持换行。</span>
                        <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="form.fieldContent" />
                    </el-form-item>
                </el-form>
            </template>
