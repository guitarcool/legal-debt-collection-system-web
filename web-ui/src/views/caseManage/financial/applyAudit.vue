        ...
        <template v-slot:default>
            ...
            >
                ...
                <el-form-item label="汇款凭证：">
                    ...
                    <el-button type="text" @click="seeErweima(form)">{{
                        form.remitEvidenceName
                    }}</el-button>
                </el-form-item>
            </el-form>
            ...
            >
                <div v-if="jointdebtId">
                    <div
                        v-for="(domain, index) in submitForm.domains"
                        :key="domain.key"
                    >
                        ...
                        <el-form-item :label="'汇款金额' + (index + 1) + '：'">
                            <el-input
                                style="width:50%"
                                disabled
                                v-model.number="domain.repayAmount"
                            ></el-input>
                        </el-form-item>
                    </div>
                </div>
                ...
                <el-form-item
                    label="审批意见："
                    :required="submitForm.operate == 0"
                >
                    <el-input
                        v-model="submitForm.option"
                        :rows="8"
                        type="textarea"
                        placeholder="请输入审批意见"
                    ></el-input>
                ...
                <el-form-item
                    label="交易流水号："
                    :required="submitForm.operate == 1"
                >
                    <el-input
                        v-model="submitForm.serialNo"
...
export default {
    ...
    methods: {
        ...
        getList() {
            //查询
            financeApi
                .getJointdebtDetail(this.jointdebtId)
                .then(response => {
            ...
            this.$refs["submitForm"].validate(valid => {
                if (valid) {
                    ...
                    let param = {
                        ...
                        remitAccountName: this.form.remitAccountName,
                        type: this.form.type,
                        id: this.id,
