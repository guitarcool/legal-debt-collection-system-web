    ...
    <div class="case-info">
            ...
            <div class="box-title two-distribution">
                ...
                <div>
                    <el-button
                        ...
                        size="mini"
                        icon="el-icon-edit"
                        v-hasPermi="['case:pretrial:getCaseEditData']"
                    ...
                    >
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                                v-hasPermi="['case:pretrial:repayment']"
                    ...
                    >
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                                v-if="
                                    firstInfo.preStatus == 0 ||
                                        firstInfo.preStatus == 4
                                "
                                @click.native="propertyEdit"
                                v-hasPermi="['case:pretrial:letterRepair']"
                                >申请诉前财保</el-dropdown-item
                            >
                            <el-dropdown-item
                                v-if="
                                    firstInfo.preStatus == 0 ||
        ...
        <div class="box">
            ...
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane label="订单信息" name="orderInfo">
                    <div class="box-content" v-if="orderInfo">
                        ...
                        <div class="small-three">
                            ...
                            <p class="small-unit-conent">
                                {{ orderInfo.insideOrderNo }}
                            </p>
                        </div>
                        <div class="small-three">
                            <p class="small-unit-header">内部客户号：</p>
                            <p class="small-unit-conent">
                                {{ orderInfo.insideCustomerNo }}
                            </p>
                        </div>
                        <div class="small-three">
                ...
                >
                    ...
                    <div class="box" style="margin-bottom:0px">
                        ...
                        >
                            ...
                            ></el-table-column>
                            <el-table-column
                                prop="repayableCapital"
                                label="应还本金"
                            ></el-table-column>
                            <el-table-column
                                prop="repayableInterest"
                                label="应还利息"
                            ></el-table-column>
                            <el-table-column
                                prop="remainRepayableAmount"
                                label="剩余应还金额"
                            ></el-table-column>
                            <el-table-column
                                prop="overdueCapital"
                            ...
                            >
                                <template slot-scope="scope">
                                    <span>{{
                                        scope.row.overdueStatus == 1
                                            ? "已逾期"
                                            : scope.row.overdueStatus == 0
                                            ? "未逾期"
                                            : ""
                                    }}</span>
                                </template>
                ...
                <el-tab-pane
                    v-if="firstInfo.showRepayRecord"
                    label="委案前还款记录"
                    name="repayRecord"
                >
                    <!--委案前还款记录列表-->
                    ...
                    >
                        ...
                        <el-form-item>
                            <el-button
                                ...
                                v-hasPermi="['case:mediationRecord:add']"
                                >保存
                            </el-button>
                ...
                <el-tab-pane label="新增网调记录" name="second">
                    ...
                    >
                        ...
                        <el-form-item>
                            <el-button
                                type="primary"
                                v-hasPermi="['case:networkAdjustRecord:add']"
    ...
    methods: {
        ...
        handleClick(tab) {
            ...
            if (
                ...
                tab.name == "repayRecord" &&
                this.repayRecordList.length == 0
            ) {
                this.getCaseBaseInfo(tab.name);
            } else if (
                tab.name == "repayPlan" &&
                this.repayPlanList.length == 0
            ) {
                this.getCaseBaseInfo(tab.name);
            }
        },
