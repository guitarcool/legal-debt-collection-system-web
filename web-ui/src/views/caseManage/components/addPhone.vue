<template>
    <Dialog :title="title" :height="350" :show.sync="dialogVisible" width="25%" @openDialog="openDialog">
        <template v-slot:default>
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                ...
                <el-form-item label="关系：" prop="relatedRelation">
                    <el-select filterable @change="handleChange" v-model="form.relatedRelation"
                        placeholder="请选择">
