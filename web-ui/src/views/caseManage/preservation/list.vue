<template>
    <div class="app-container">
            ...
            <template #default>
                ...
                <el-form-item label="账龄（M）：">
                    <el-input
                        ...
                        size="small"
                        style="width:100px"
                        v-model="queryParams.overdueStartAge"
                    />~
                    <el-input
                        clearable
                        size="small"
                        style="width:100px"
                        v-model="queryParams.overdueEndAge"
                    />
                </el-form-item>
                <el-form-item label="号码筛选状态：">
                    <el-select
                        ...
                        filterable
                        size="small"
                        v-model="queryParams.screenStatus"
                        placeholder="请选择"
                    >
                        <el-option
                            v-for="item in screen_status"
                            :key="item.dictValue"
                ...
                <el-form-item label="号码筛选结果：">
                    <el-cascader
                        ...
                        filterable
                        size="small"
                        v-model="queryParams.screenResults"
                        :options="screenResultOptions"
                        placeholder="请选择"
                    >
                    </el-cascader>
                </el-form-item>
                <el-form-item label="最近一次调解时间：">
                    <el-date-picker
                        v-model="chooseDaterange2"
                        type="daterange"
                        size="small"
                        range-separator="至"
                        start-placeholder="调解开始日期"
                        end-placeholder="调解结束日期"
                        format="yyyy-MM-dd"
                ...
                <el-form-item label="无调解天数：">
                    <el-cascader
                        ...
                        filterable
                        size="small"
                        v-model="queryParams.noMedDay"
                        :options="noMedDayOptions"
                        placeholder="请选择"
                    >
                    </el-cascader>
                </el-form-item>
                <el-form-item label="无通话记录天数：">
                    <el-cascader
                        ...
                        filterable
                        size="small"
                        v-model="queryParams.noCallDay"
                        :options="noCallDayOptions"
                        placeholder="请选择"
                    >
                    </el-cascader>
                </el-form-item>
                ...
                <el-form-item label="网调标签：">
                    <el-select
                        ...
                        filterable
                        size="small"
                        v-model="queryParams.networkAdjustLabel"
                        placeholder="请选择"
                    >
                        <el-option
                ...
                <el-form-item label="短信送达结果：">
                    <el-cascader
                        ...
                        filterable
                        size="small"
                        v-model="queryParams.deliverResult"
                        :options="shortmsgOptions"
                        placeholder="请选择"
                    >
                    </el-cascader>
                </el-form-item>
                ...
                <transition name="fade">
                    <div v-show="isShow" transiton="fade">
                        <div style="padding: 10px 0;font-weight:700">
                            高级查询:
                        </div>
                        ...
                        <el-form-item label="公众号名称：">
                            <el-select
                                ...
                                filterable
                                size="small"
                                v-model="queryParams.bindWechatId"
                                placeholder="请选择"
                            >
                                <el-option
                ...
                <transition name="fade">
                    <div v-show="isShow" transiton="fade">
                        ...
                        <el-form-item label="委案状态：" class="custom-radio">
                            <el-radio-group
                                v-model="queryParams.entrustStatus"
                                @change="changeStatus"
                            >
                                <el-radio
                        ...
                        <el-form-item label="信修状态：" class="custom-radio">
                            <el-radio-group
                                v-model="queryParams.letterRepairStatus"
                                @change="changeStatus"
                            >
                                <el-radio label="">全部</el-radio>
                                <el-radio
                                    v-for="item in letterRepairStatusOptions"
                                    :label="item.dictValue"
                                    :key="item.dictValue"
                                    >{{ item.dictLabel }}</el-radio
                                >
        ...
        <div class="queryDiv">
            查询结果统计：<span
                >列表案件量：{{
                    otherParam.caseTotalCount ? otherParam.caseTotalCount : ""
                }}件；</span
            ><span
                >列表标的金额：{{
                    otherParam.subjectTotalAmount
                        ? otherParam.subjectTotalAmount
                        : ""
                }}元；</span
            ><span
                >列表剩余待还总额：{{
                    otherParam.totalRemainingBalance
                        ? otherParam.totalRemainingBalance
                        : ""
                }}元；</span
            >
        ...
        <div class="box-contnet-wrap" style="margin-top:0">
            <el-row :gutter="10" class="mb8">
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        type="warning"
                        @click="handleThawing()"
                        v-hasPermi="['case:property:unfreeze']"
                        :disabled="multiple"
                        >批量解冻
                    </el-button>
                </el-col>
                ...
                <el-col :span="1.5">
                    <el-button
                        v-hasPermi="['case:pretrial:batchPending']"
                        v-if="
                            queryParams.caseStatuss.indexOf('1') > -1 == true ||
                                queryParams.caseStatuss.indexOf('6') > -1 ==
                                    true
                        "
                        type="success"
                        size="mini"
                        @click="handleOnRecord(1)"
                        :disabled="multiple"
                        >批量民事立案申请</el-button
                    >
                </el-col>
                <el-col :span="1.5">
                    <el-button
                        v-hasPermi="['case:pretrial:batchPendingAll']"
                        v-if="
                            queryParams.caseStatuss.indexOf('1') > -1 == true ||
                                queryParams.caseStatuss.indexOf('6') > -1 ==
                                    true
            ...
            <el-row :gutter="10" class="mb8">
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        :disabled="multiple"
                        v-hasPermi="[
                            'case:pretrial:batchExportMediationRecord'
                        ]"
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        :disabled="multiple"
                        v-hasPermi="[
                            'case:pretrial:batchExportNetworkAdjustRecord'
                        ]"
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        size="mini"
                        :disabled="multiple"
                        v-hasPermi="['case:pretrial:batchSMSFile']"
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        size="mini"
                        :disabled="multiple"
                        v-hasPermi="['case:pretrial:batchSMS']"
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        size="mini"
                        :disabled="multiple"
                        @click="handleAppleEdit(1)"
                        v-hasPermi="['case:pretrial:letterRepair']"
                        >批量申请案件信修
                    </el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button
                        v-if="
                            queryParams.caseStatuss.indexOf('13') > -1 ==
                                false && token
                        "
                        type="primary"
                        size="mini"
                        :disabled="multiple"
                        @click="handleAppleCall"
                        >批量预测式外呼
                    </el-button>
                </el-col>
            </el-row>
            <el-row :gutter="10" class="mb8">
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        size="mini"
                        v-hasPermi="[
                            'case:pretrial:batchExportMediationRecordAll'
                        ]"
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        size="mini"
                        v-hasPermi="[
                            'case:pretrial:batchExportNetworkAdjustRecordAll'
                        ]"
                ...
                <el-col :span="1.5">
                    <el-button
                        ...
                        type="warning"
                        size="mini"
                        v-hasPermi="['case:pretrial:batchSMSAll']"
                ...
                <el-col :span="1.5">
                    <el-button
                        type="primary"
                        size="mini"
                        @click="batchLawyerAll"
                        v-hasPermi="['case:pretrial:instrumentBatchAll']"
                        >全选生成律师函
                    </el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button
                        type="success"
                        size="mini"
                        @click="handleAppleEdit(2)"
                        v-hasPermi="['case:pretrial:letterRepairAll']"
                        >全选申请案件信修
                    </el-button>
                </el-col>
                <right-toolbar
            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        <span v-if="scope.row.providerType == 1">{{
                            shisuyunStatusFormat(scope.row.deliverStatus) != ""
                                ? shisuyunStatusFormat(scope.row.deliverStatus)
                                : scope.row.deliverStatus
                        }}</span>
                        <span v-if="scope.row.providerType == 2">{{
                            wodongStatusFormat(scope.row.deliverStatus) != ""
                                ? wodongStatusFormat(scope.row.deliverStatus)
                                : scope.row.deliverStatus
                        }}</span>
                        <span v-if="scope.row.providerType == 3">{{
                            xuanwuStatusFormat(scope.row.deliverStatus) != ""
                                ? xuanwuStatusFormat(scope.row.deliverStatus)
                                : scope.row.deliverStatus
                        }}</span>
                    </template>
                ...
                <el-table-column
                    label="联系状态"
                    :formatter="getContactStatusOptions"
                    prop="contactStatus"
                >
                </el-table-column>
                <el-table-column
                ...
                <el-table-column
                    label="信修状态"
                    :formatter="getLetterRepairStatus"
                    prop="letterRepairStatus"
                >
                </el-table-column>
                <el-table-column
                    label="最近一次网调标签"
                    width="150"
                    :formatter="getAdjustType"
                    prop="networkAdjustLabel"
                >
                </el-table-column>
                <el-table-column
                    label="前通话记录"
                ...
                >
                    <template slot-scope="scope">
                        <el-button
                            ...
                            v-hasPermi="['case:pretrial:record']"
                            >调解记录
                        </el-button>
                        <el-button
                            size="mini"
                            ...
                            v-hasPermi="['case:pretrial:query']"
                            >查看
                        </el-button>
                        <el-button
                            size="mini"
        ...
        <recordDialog
            ...
            :show.sync="recordData.dialogVisible"
            :id="recordData.id"
        >
        </recordDialog>
        <exportDialog
            :requestApi="exportDialogData.requestApi"
            :title="exportDialogData.title"
            :show.sync="exportDialogData.dialogVisible"
            :id="exportDialogData.id"
            :contractNo="exportDialogData.contractNo"
            @refresh="clearSelection"
        ></exportDialog>
        <batchExportDialog
            @refresh="clearSelection"
            :requestApi="batchData.requestApi"
            :title="batchData.title"
            :show.sync="batchData.dialogVisible"
            :params="batchData.params"
        ...
        <testCall
            ...
            :show.sync="callData.dialogVisible"
            :ids="callData.ids"
        >
        </testCall>
        <batchExport
            @refresh="clearSelection"
            :title="batchexportData.title"
            :show.sync="batchexportData.dialogVisible"
            :red="batchexportData.red"
            :params="batchexportData.params"
            :total="batchexportData.total"
        ></batchExport>
        <mediationRecord
            @refresh="clearSelection"
            :title="mediationData.title"
            :show.sync="mediationData.dialogVisible"
            :ids="mediationData.ids"
            :type="mediationData.type"
            :total="mediationData.total"
        ></mediationRecord>
        <multipleSuccess
            :confirmTip="multipleSuccessfully.confirmTip"
            :title="multipleSuccessfully.title"
            :id="multipleSuccessfully.id"
            @refresh="clearSelection"
    ...
    methods: {
        ...
        handleAppleEdit(type) {
            ...
            this.selection.forEach(item => {
                if (
                    item.letterRepairStatus == 1 ||
                    item.letterRepairStatus == 2
                ) {
